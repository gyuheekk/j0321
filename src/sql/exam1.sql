...
-- 6. 'sample 데이터베이스를 만드시오.
			/*(기본값이 utf8형식이나, 별도로 utf8 형식으로 생성하고자 한다면,
				 기술된 명령어뒤에 '~  character set utf8 collate utf8_general_ci;'를 추가해주면 된다.) */
...
select name,age,gender,assress from sinsang where address='서울' or address='부산';
